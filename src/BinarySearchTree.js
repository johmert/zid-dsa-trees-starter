...
class BinarySearchTree {
  ...
  insert(key, value) {
    /**
     * If the tree is empty, then the key being inserted
     ...
     */
       ...
       * then you can just instaniate and insert the new node
  ...
  remove(key) {
    if(this.key == key) {
      ...
      * then you replace it with the right child.
      */
      else if (this.right) {
       ...
       * then simply remove it and any references to it
